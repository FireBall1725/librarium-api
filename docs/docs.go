...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "items": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/github_com_fireball1725_librarium-api_internal_repository.DuplicateCandidate"
                                    }
                                },
                                "total": {
                                    "type": "integer"
        ...
        "/admin/contributor-duplicates/dismiss": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "The contributors that are not the same person",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/contributor-duplicates/merge": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Who survives, and who folds into them",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/books/{book_id}/contents": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Container book UUID",
                        "name": "book_id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/books/{book_id}/contents/{contained_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Contained book UUID",
                        "name": "contained_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/editions/{edition_id}/identifiers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/editions/{edition_id}/identifiers/{scheme}/{value}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Scheme code, e.g. isbn13",
                        "name": "scheme",
                        "in": "path",
                        "required": true
                    },
        ...
        "/libraries/{library_id}/book-by-identifier": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Identifier scheme, e.g. upc or ean",
                        "name": "type",
                        "in": "query",
                        "required": true
                    },
        ...
        "/libraries/{library_id}/inventory": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "A place UUID, or none",
                        "name": "location",
                        "in": "query"
                    },
                    {
        ...
        "/libraries/{library_id}/locations": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/lookup/upc/learn": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Back-cover code with add-on, and the book's ISBN-13",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/me/lists/{list_id}/books/{book_id}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/me/wishlist/{entry_id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Wishlist entry UUID",
                        "name": "entry_id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "github_com_fireball1725_librarium-api_internal_providers.ISBNCandidate": {
            "type": "object",
            "properties": {
                "isbn": {
                    "type": "string"
        ...
        "github_com_fireball1725_librarium-api_internal_providers.MergedBookResult": {
            ...
            "properties": {
                ...
                "other_isbns": {
                    "description": "OtherISBNs are the other books the same add-on could be, when the\npublisher has more than one ISBN prefix and more than one resolved.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_fireball1725_librarium-api_internal_providers.ISBNCandidate"
                    }
                },
                "page_count": {
                    "$ref": "#/definitions/github_com_fireball1725_librarium-api_internal_providers.FieldResult"
        ...
        "github_com_fireball1725_librarium-api_internal_repository.DuplicateCandidate": {
            "type": "object",
            "properties": {
                "key": {
                    "description": "Key is the normalised name the members share. Sent so a client has\nsomething stable to key a row on.",
                    "type": "string"
                },
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_fireball1725_librarium-api_internal_repository.DuplicateMember"
                    }
                }
            }
        },
        "github_com_fireball1725_librarium-api_internal_repository.DuplicateMember": {
            "type": "object",
            "properties": {
                "books": {
                    "type": "integer"
